...
<Card>
  ...
  <CardContent className="space-y-2">
    <div className="flex justify-between items-center">
      ...
      <span className=" text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">{counts.new}</span>
    </div>
    ...
    <div className="flex justify-between items-center">
      ...
      <span className=" text-yellow-800 text-xs font-semibold px-2.5 py-0.5 rounded">{counts.contacted}</span>
    </div>
    ...
    <div className="flex justify-between items-center">
      ...
      <span className=" text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">{counts.converted}</span>
    </div>
